...
namespace Seivad
{
    internal class ObjectCreator
    {
        ...
        public Object GetInstance(IList<Object> args)
        {
        ...
        private object CreateInstanceAndApplyAction(IList<Object> args)
        {
            var result = Activator.CreateInstance(ReturnType, args.ToArray());
